...
export class CarDetailsComponent implements OnInit {
  ...
  fixedPrice :number;
  amount = { totalPrice:0}
  constructor(private carDetailsService: CarDetailsService,private activatedRoute:ActivatedRoute, private cartService:CartService, private toastrService:ToastrService) { }
